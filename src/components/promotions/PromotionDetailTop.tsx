      ...
      <Container className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        <div className="flex flex-col gap-6">
          ...
          <dl className="flex flex-col gap-1 font-inter">
            ...
            <div className="flex gap-2">
              <dt className="font-semibold text-white">Valid:</dt>
          ...
          {promotion.terms ? (
            <div className="flex flex-col gap-3">
              ...
              <div
                className="font-inter text-sm leading-relaxed [&_a]:underline [&_li]:mb-1 [&_ol]:list-decimal [&_ol]:pl-5 [&_ul]:list-disc [&_ul]:pl-5"
