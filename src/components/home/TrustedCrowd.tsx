...
const CARDS = [
  { img: "/home/trusted-1.png", title: "Lorem Ipsum" },
  { img: "/home/trusted-2.png", title: "Lorem Ipsum" },
  { img: "/home/trusted-3.png", title: "Lorem Ipsum" },
];

/** Trusted by the City's Crowd (Figma 441:48) — 3 community cards. */
      ...
      <Container className="flex flex-col items-center gap-12">
        ...
        <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-3">
          {CARDS.map((card, i) => (
            <article
              key={i}
              className="flex flex-col overflow-hidden border border-sf-border/60 bg-sf-surface"
            >
