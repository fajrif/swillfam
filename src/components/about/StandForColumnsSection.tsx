    ...
    <section className="py-16 lg:py-24">
      <Container>
        <div className="grid border border-sf-border/40 lg:grid-cols-2">
          {/* Destinations */}
          <div className="flex flex-col gap-8 border-b border-sf-border/40 p-8 sm:flex-row lg:border-b-0 lg:p-10">
            <div className="relative aspect-[382/522] w-full shrink-0 overflow-hidden sm:w-[260px]">
              <Image
          ...
          {/* Our Experiences */}
          <div className="flex flex-col justify-center gap-4 p-8 lg:border-l lg:border-sf-border/40 lg:p-10">
            <h3 className="font-syne text-[clamp(1.75rem,3vw,40px)] leading-tight text-white">
              Our Experiences
            </h3>
            <p className="font-inter leading-relaxed text-white">
              SwillFam brings together food, drinks, music, entertainment, and community to create
              memorable moments.
            </p>
            <p className="font-inter leading-relaxed text-white">
