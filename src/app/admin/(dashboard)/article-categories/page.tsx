...
export default async function ArticleCategoriesPage(props: { searchParams: Promise<{ q?: string; page?: string }> }) {
  ...
  const total = await prisma.articleCategory.count({ where });
      ...
      <Card>
        <AdminTable
          ...
          columns={[
            ...
            { header: "Articles", cell: (c) => c._count.articles },
          ]}
        />
